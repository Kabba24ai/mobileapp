...
//            sliderTextLabel.semanticContentAttribute = .forceLeftToRight
            textLabel.alpha = 1
            textLabel.text = labelText
            sliderTextLabel.text = labelText
            
//            textLabel.textAlignment = UserDefaults.standard.language == "ar" ? .left : .right
//            sliderTextLabel.textAlignment = UserDefaults.standard.language == "ar" ? .left : .right
        }
    }
    ...
    private func setupConstraint() {
        ...
        let position = UserDefaults.standard.language == "ar" ? manageWidth(size: 10) : manageWidth(size: 20)
        textLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: position).isActive = true
...
//        }
    ...
    @objc private func handlePanGesture(_ sender: UIPanGestureRecognizer) {
        ...
        let position = UserDefaults.standard.language == "ar" ? self.isOnLeftToRightLanguage() : self.isOnRightToLeftLanguage()
        let translatedPoint = abs(sender.translation(in: view).x * (position ? -1 : 1))
    ...
    func isOnLeftToRightLanguage() -> Bool {
