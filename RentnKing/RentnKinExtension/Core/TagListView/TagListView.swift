...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var removeIconLineColor: UIColor = UIColor.black.withAlphaComponent(0.54) {
        didSet {
            defer { rearrangeViews() }
            tagViews.forEach {
...
//    }
    ...
    private func createNewTagView(_ title: String, tag :Int, isRemovButton : Bool) -> TagView {
        let tagView = TagView(title: title, tag: tag)
        tagView.tag = tag
        ...
        tagView.enableRemoveButton = isRemovButton
...
//        }
    ...
    @discardableResult
    open func addTag(_ title: String, tag : Int, isRemovButton : Bool) -> TagView {
        defer { rearrangeViews() }
        return addTagView(createNewTagView(title, tag: tag, isRemovButton: isRemovButton))
    }
    ...
    @discardableResult
    open func insertTag(_ title: String, at index: Int, isRemovButton : Bool) -> TagView {
        return insertTagView(createNewTagView(title, tag: index, isRemovButton: isRemovButton), at: index)
    }
