...
class MachineFilterViewController: UIViewController, UIGestureRecognizerDelegate {
    weak var delegate : MachineFilterProtocol? = nil
...
extension MachineFilterViewController {
...
extension MachineFilterViewController : UITableViewDelegate, UITableViewDataSource{
