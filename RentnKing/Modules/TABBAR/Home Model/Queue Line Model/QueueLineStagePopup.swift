...
//  RentnKing
//
//  Queue Line popup infrastructure. Contains the shared modal base and the
//  Change Equipment popup. The former staging popups (the fuel/key
//  mini-checklist + staged-details) were retired 2026-09 — staging is now the
//  Delivery Checklist's explicit Save (checklist-driven Queue Line).
//
...
// (Checklist-driven staging, 2026-09: the former Mark as Staged popup —
// the Queue Line fuel/key mini-checklist — and the Staged-details popup were
// retired. Selecting a Queue Line item opens the ONE main Delivery Checklist;
// a 100%-complete checklist + Save stages the item, and un-completing the
// prepared checklist returns it to Pending. See QueueLineViewController.)
