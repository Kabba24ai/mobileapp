...
//  BAYNOUNAH
//
//  Created by Jigar Khatri on 14/07/22.
//
    ...
    public struct GradientConfiguration {
        ...
        */
        ...
        fileprivate mutating func setMainColor(_ color: UIColor) {
            backgroundColor = color.backgroundColor(brightness: 0.98)
            primaryColor = color.primaryColor(brightness: 0.95)
            secondaryColor = color.secondaryColor(brightness: 0.88)
        }
...
//CHANGE COLOUR CODE HERE
extension UIColor {
    
    fileprivate func backgroundColor(brightness: CGFloat) -> UIColor {
        return UIColor.secondary.withAlphaComponent(1.0)
    }
    fileprivate func primaryColor(brightness: CGFloat) -> UIColor {
        return UIColor.secondary.withAlphaComponent(1.0)
    }
    fileprivate func secondaryColor(brightness: CGFloat) -> UIColor {
        return UIColor.secondary.withAlphaComponent(1.0)
    }
