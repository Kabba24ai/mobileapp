...
extension UILabel {
    ...
    func configureLable(textAlignment : NSTextAlignment = .left, textColor:UIColor?, fontName:String, fontSize : Double, text:String, numberOfLines : Int = 0) {
...
//        ]
        ...
        let attributedString = NSMutableAttributedString(string: str, attributes: [
            .foregroundColor: UIColor.primaryView!,
            .underlineStyle: NSUnderlineStyle.single.rawValue,
          .kern: 0.0
        ])
        attributedString.addAttribute(.foregroundColor, value: UIColor.secondaryView!, range: NSRange(location: location, length: lenght))
...
extension UITextField{
    func configureText(textAlignment : NSTextAlignment = UserDefaults.standard.language == "ar" ? .right : .left, keyboardTye : UIKeyboardType = .default, bgColour : UIColor, textColor:UIColor?, fontName:String, fontSize : Double, text:String, placeholder : String) {
        self.backgroundColor = bgColour
        self.textAlignment = textAlignment
        ...
        self.attributedPlaceholder = NSAttributedString(string: placeholder,
                                                        attributes: [NSAttributedString.Key.foregroundColor:  UIColor.lightGray.withAlphaComponent(1.0) ,NSAttributedString.Key.font:  SetTheFont(fontName: fontName, size: fontSize)])
    }
    ...
    func configureTextWhite(bgColour : UIColor, textColor:UIColor?, fontName:String, fontSize : Double, text:String, placeholder : String) {
        ...
        self.attributedPlaceholder = NSAttributedString(string: placeholder,
                                                        attributes: [NSAttributedString.Key.foregroundColor:  UIColor.primaryView! ,NSAttributedString.Key.font:  SetTheFont(fontName: fontName, size: fontSize)])
    }
}
